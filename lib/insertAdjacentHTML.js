if (document && !('createElementNS' in document)) {
  (HTMLDocument || Document).prototype.createElementNS = function (uri, name) {
...
if (document &&
  ...
  (HTMLElement || Element).prototype.insertAdjacentHTML = function(position, html) {
      "use strict";
